...
**6** - Fazer com que os vídeos do seu canal sejam **automaticamente enviados** assim que forem postados no <#${ids_1.VIDEOS_CHANNEL_ID}>, e a criação de uma role especial para notificar a galera!
